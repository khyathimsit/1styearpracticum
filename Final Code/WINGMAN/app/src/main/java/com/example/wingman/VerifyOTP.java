                ...
                .addOnCompleteListener(VerifyOTP.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Validate(Name,Phone,Mail,Password, Hash);
...
//                            startActivity(intent);
    ...
    private void Validate(final String name, final String phone, final String mail, final String pswd, final String hash) {
...
//                if (!(dataSnapshot.child("Users").child(uid).exists())) {
                uid = FirebaseAuth.getInstance().getCurrentUser().getUid();
                    ...
                    userdataMap.put("hashkey", hash);

                    RootRef.child("Users").child(uid).updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Log.d("task is successfull", "Successfullyu added");
                                ...
                                //loadingBar.dismiss();
                                Log.d("task is not successfull", "Successfullyu not added");
