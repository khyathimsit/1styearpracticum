...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText username, phoneNumber, password, email, hashkey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hashkey = findViewById(R.id.register_key);
    ...
    private void CreateAccount() {
        ...
        String hash = hashkey.getText().toString();
        ...
        if(TextUtils.isEmpty(name)){
            ...
            Toast.makeText(this, "Please enter the Hash Key", Toast.LENGTH_SHORT).show();
        }
        else{
        ...
        String str = name + ","+ phone + "," + pswd + "," + mail + "," + hash;
